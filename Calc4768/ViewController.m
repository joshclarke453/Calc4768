...
//This method will take any number button pressed and append the content into the textfield.
...
//It will get the square root of whatever is in the textfield.
...
//If this is the second click of the same operation before the '=' button is clicked, it will complete the operation and set the tempNum variable to the answer. This allows users to do multiple operations in sequence without having to hit the '=' key, such as user inputs like '1+1+1+1' before hitting '=' will work and give the user the correct answer.
